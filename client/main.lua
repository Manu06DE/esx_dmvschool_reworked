...
function OpenDMVSchoolMenu()
	...
	if ownedLicenses['dmv'] then
		...
		if not ownedLicenses['drive_truck_hvy'] then
			table.insert(elements, {
				label = (('%s: <span style="color:green;">%s</span>'):format(_U('road_test_truck_hvy'), _U('school_item', ESX.Math.GroupDigits(Config.Prices['drive_truck_hvy'])))),
				value = 'drive_test',
				type = 'drive_truck_hvy'
			})
		end
	end
